...
#define BUZZ_PIN 6
// #define BUZZ_PIN 7 //Re-route buzzer to the blinky light
...
inline void prvReadSensors(){
  ...
  //Using FIltered
  attitude_estimate.update_estimate(a_filtered, g_filtered, dt, rocketState == ROCKET_PRE); //only fuse if in pre-flight
